...
cp $build_dir/source_modules/ArcaleServer_source/Release/ArcaleServer_source.dll sdrpp_windows_x64/modules/

cp $build_dir/source_modules/harogic_source/Release/harogic_source.dll sdrpp_windows_x64/modules/
cp 'C:/radio/HTRA_API/x64/htra_api/htra_api.dll' sdrpp_windows_x64/
cp 'C:/radio/HTRA_API/x64/htra_api/libiomp5md.dll' sdrpp_windows_x64/
cp 'C:/radio/HTRA_API/x64/htra_api/libliquid.dll' sdrpp_windows_x64/
cp 'C:/radio/HTRA_API/x64/htra_api/libmkl.dll' sdrpp_windows_x64/
cp 'C:/radio/HTRA_API/x64/htra_api/vcomp140.dll' sdrpp_windows_x64/
cp 'C:/radio/HTRA_API/x64/htra_api/vcruntime140.dll' sdrpp_windows_x64/
