...
namespace ImGui {
    ...
    void WaterFall::processInputs() {
        ...
        if ((VFOMoveSingleClick ? ImGui::IsMouseClicked(ImGuiMouseButton_Left) : ImGui::IsMouseDown(ImGuiMouseButton_Left)) && (mouseInFFT | mouseInWaterfall) && (mouseMoved || hoveredVFOName == "") && !gui::mainWindow.frequencyLocked) {
            if (selVfo != NULL) {
