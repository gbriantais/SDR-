...
int sdrpp_main(int argc, char* argv[]) {
    ...
    defConfig["frequencyLocked"] = false;
    defConfig["fullWaterfallUpdate"] = false;
    defConfig["max"] = 0.0;
    defConfig["maximized"] = false;
    defConfig["fullscreen"] = false;
    // Sauvegarde du zoom (position du slider 0.0 → 1.0)
    defConfig["viewBandwidthSlider"] = 1.0;
    ...
    defConfig["moduleInstances"]["ArcaleServer Source"]["module"] = "ArcaleServer_source";
    defConfig["moduleInstances"]["ArcaleServer Source"]["enabled"] = true;
    ...
    defConfig["windowPosition"]["top"] = 35;
    defConfig["windowSize"]["h"] = 720;
    defConfig["windowSize"]["w"] = 1280;
    defConfig["mutedLock"] = true;
    defConfig["mutedLeft"] = true;
    ...
    defConfig["frequency_limits"]["enabled"] = false; // Désactiver par défaut

    // Facteur de largeur de bande
    defConfig["bandwidthFactor"] = 0.9;
